...
api.get('/cb', function(req, res) {
    ...
    console.log(code)
    request(`https://github.com/login/oauth/access_token?client_id=aeba3b94f917b3653e41&client_secret=17a018cc118b5c7a320ab49fda8891bacd99e581&code=${code}&redirect_uri=`).then((str)=>{
