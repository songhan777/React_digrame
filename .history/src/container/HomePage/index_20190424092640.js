...
class HomePage extends Component {
    ...
    oauth = () => {
        ...
        const authWin = window.open(`https://passport.escience.cn/oauth2/authorize?response_type=code&redirect_uri=YOUR_REGISTERED_REDIRECT_URI&client_id=YOUR_CLIENT_ID&theme=YOUR_THEME`, '_blank')
