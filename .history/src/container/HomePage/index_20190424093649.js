...
class HomePage extends Component {
    ...
    oauth = () => {
        ...
        const authWin = window.open(`https://passport.escience.cn/oauth2/authorize?response_type=code&redirect_uri=http://flow.dv.ailab.win/user/oauth/cb&client_id=YOUR_CLIENT_ID&theme=full`, '_blank')
