...
import { getOAuthJson} from '../../API/API'
...
class HomePage extends Component {
    ...
    oauth = () => {
        ...
        const authWin = window.open(`https://github.com/login/oauth/authorize?client_id=aeba3b94f917b3653e41&redirect_uri=${redirect_uri}&scope=user:email`, '_self')
            ...
            <div className={classes.root}>
                ...
                <div className={classes.first}>
                    <div className={classes.modle}>
                        ...
                        <Button  variant="contained" className={classes.loginButton} size="medium" onClick={this.login} component={Link} to="/pjl">登 录</Button>
