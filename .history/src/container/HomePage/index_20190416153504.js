...
class HomePage extends Component {
    ...
    oauth = () => {
        ...
        if (DEV) {
            redirect_uri = 'http://localhost:3000/user/oauth/cb'
        } else {
            redirect_uri = 'http://localhost:3000/user/oauth/cb'
        }
        const authWin = window.open('https://github.com/login/oauth/authorize?client_id=aeba3b94f917b3653e41&scope=user:email', '_blank')
            ...
            <div className={classes.root}>
                ...
                <div className={classes.first}>
                    <div className={classes.modle}>
                        ...
                        <Button component={Link} variant="contained" className={classes.loginButton} size="medium"
                                to="/pjl">登 录</Button>
