...
var HomePage = (_temp2 = _class = function (_Component) {
    ...
    function HomePage() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HomePage.__proto__ || Object.getPrototypeOf(HomePage)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            var authWin = window.open('https://github.com/login/oauth/authorize?client_id=aeba3b94f917b3653e41&redirect_uri=' + redirect_uri + '&scope=user:email');
...
//# sourceMappingURL=home.15948716dc8ac64f4798.hot-update.js.map