...
var _history = __webpack_require__(/*! ../component/history */ "./src/component/history.js");
...
var fn = (0, _mobxReact.observer)(function (props) {
    return function (res) {
        console.log(props);
        console.log(res);
        return res.data;
...
_axios2.default.interceptors.response.use(fn);
...
//# sourceMappingURL=home.1e629b0c6f8c10fb5b10.hot-update.js.map