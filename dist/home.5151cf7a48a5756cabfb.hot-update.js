...
var HomePage = (_temp2 = _class = function (_Component) {
    ...
    function HomePage() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HomePage.__proto__ || Object.getPrototypeOf(HomePage)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            showPassword: false,
            foucse: false
        }, _this.handlePasswordChange = function (prop) {
        ...
        }, _this.login = function () {}, _this.oauth = function () {
            var redirect_uri = null;
            if (true) {
                redirect_uri = 'http://localhost:3000/user/oauth/gitcb';
            } else {}
            var authWin = window.open('https://github.com/login/oauth/authorize?client_id=aeba3b94f917b3653e41&redirect_uri=' + redirect_uri + '&scope=user:email', '_self');
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _Button2.default,
                            { variant: 'contained', className: classes.loginButton, size: 'medium', onClick: this.login, component: _reactRouterDom.Link, to: '/pjl' },
                            '\u767B \u5F55'
                        ),
                        _react2.default.createElement(
                            _Button2.default,
...
exports.default = (0, _core.withStyles)(_css.styles)(HomePage);

/***/ })

})
//# sourceMappingURL=home.5151cf7a48a5756cabfb.hot-update.js.map