...
import {registeredUser, repeatNameShow} from "../../API/API";
...
class Register extends Component {
    ...
    render() {
        ...
        const {passwordEmpty, passwordPrompt, newPasswordEmpty, newPasswordPrompt, newPasswordCompare,repeatNameShow,showNameShow} = this.state;
        return (
                ...
                <div className={classes.registerBox}>{/*这里的使用值是再背景一个是在img中*/}
                    <div className={classes.listBox}>
                        ...
                        <Paper className={classes.inputBox} elevation={1}
                            ...
                            <InputBase className={classes.input} placeholder="用户名" onBlur={(e) => {
