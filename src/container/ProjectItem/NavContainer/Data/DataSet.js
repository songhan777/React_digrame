...
class DataSet extends Component {
    ...
    componentDidMount() {
        ...
        getDataSet({id: 111111, projectId: projectId, dataSetId: dataSetId}).then(data => {
    ...
    LocalUpload = () => {
        return (this.state.uploadShow ?
            <UploadFile change={this.ShutDownUpload} LocalUpload={LocalUpload} addData={this.setAddDatabase}/> : null)
    };
    showDatabase = () => {
        return (this.state.databaseShow ?
            <AddDatabase addData={this.setAddDatabase} change={this.handleDatabase}/> : null)
    };
